...
def eval_downstream(inf_test_embeddings, targets, col_id="customer_id", target_col="gender", downstream_type="catboost"):
    ...
    if downstream_type == "catboost":
        model = catboost.CatBoostClassifier(iterations=150, loss_function='Logloss', random_seed=42, verbose=0)
    else:
