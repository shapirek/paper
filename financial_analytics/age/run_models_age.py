...
class ModelKeeper:
    ...
    def train_model(self, hyperparams, checkpoints_path, recalculate=False, devices=0):
        ...
        # Ключевое отличие от gender: другие поля
        trx_encoder_params = dict(
            embeddings_noise=0.003,
            linear_projection_size=hyperparams['embedding_dim'],
            embeddings={
                "trans_date": {"in": hyperparams['trans_date_in'], "out": hyperparams['category_embedding_dim']},
                "small_group": {"in": hyperparams['small_group_in'], "out": hyperparams['category_embedding_dim']},
            },
